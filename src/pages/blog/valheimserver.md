...
subtitle: >-
  ...
  Azure 
---
*Editors Note: The pictures used are from a test run I did, so the IP and other, normally sensitive, information aren't hidden as this build of the server is no longer active.*
